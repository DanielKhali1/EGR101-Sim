...
public class Intanstiate : MonoBehaviour
{
    // the Equip prefab - required for instantiation
    public GameObject UltrasonicSensor;
    ...
    public void CreateObject()
    {
        ...
        if (UltrasonicSensor != null)
        {
            ...
            GameObject go = (GameObject)Instantiate(UltrasonicSensor, position, Quaternion.identity);
